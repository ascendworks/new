    ...
    <footer className="bg-navy border-t border-white/8">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-3 mb-8">
              <a
                ...
                className="flex items-center gap-2 text-slate hover:text-white text-sm transition-colors group"
              >
          ...
          {/* Links columns */}
          <div>
            <p className="text-white font-600 text-sm mb-5 uppercase tracking-wider">
              Services
            </p>
      ...
      <div className="border-t border-white/8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate/60 text-xs">
            © 2026 AscendWorks Inc. All rights reserved.
          </p>
          <div className="flex gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item) => (
              <Link
                key={item}
                href="#"
                className="text-slate/60 hover:text-slate text-xs transition-colors"
              >
                {item}
              </Link>
            ))}
